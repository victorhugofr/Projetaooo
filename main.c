...
int main(int argc, char const *argv[]) {
	...
	int limiar;
	if ( (strcmp(filename, "Catarata.ppm") == 0) || (strcmp(filename, "Extra2.ppm") == 0) ) {
		limiar = 35; //OK
	}
	...
	else if ( (strcmp(filename, "Normal2.ppm") == 0) || (strcmp(filename, "Extra1.ppm") == 0) ) {
		limiar = 50; //OK
	}
	else if (strcmp(filename, "Extra3.ppm") == 0) {
		limiar = 55;
	}
	else if (strcmp(filename, "Extra4.ppm") == 0) {
		limiar = 40;
	}
	else if (strcmp(filename, "Extra5.ppm") == 0) {
		limiar = 50;
	}
	else {
	...
	if (strcmp(filename, "Extra4.ppm") == 0) {
